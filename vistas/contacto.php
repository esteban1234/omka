...
<section id="contact">
  ...
  <div class="row">
    <div class="col-md-7">
        ...
        <p><i class="fas fa-map-marker-alt " style="color: #57C0D3;"></i> Dirección: Av. 4A NTE PTE #688 C2 entre 5-A y 6A PTE Argentin Col. Teran, Tuxtla Gutierrez, Chiapas. C.P. 29050.</p>
        <p><i class="fas fa-phone " style="color: #57C0D3;"></i> Teléfono: PENDIENTE</p>
        <p><i class="fas fa-envelope " style="color: #57C0D3;"></i> Correo: info@limpiezaomka.com</p>
        <p><i class="fas fa-clock " style="color: #57C0D3;"></i> Horario: Lunes a Viernes de 9 am a 6 pm</p>
      </div>
